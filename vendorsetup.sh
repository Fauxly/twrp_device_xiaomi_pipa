...
#
# For details about the Orange Fox variable, see fox_12.1/vendor/recovery/orangefox_build_vars.txt

	export TW_DEFAULT_LANGUAGE="en_US"
	export LC_ALL="C"
	export ALLOW_MISSING_DEPENDENCIES=true

	echo -e "\x1b[96mpipa: Start adding vOrangeFox Vars...\x1b[m"
	## 构建信息
	# 设置显示在关于页面里的维护人员名称
	...
	F=$(find "device" -maxdepth 2 -name "pipa")
	# 修改启动画面背景色为#000000
	...
	echo -e "\x1b[96mpipa: 当你看到这个消息的时候，所有的OrangeFox Var已经添加完毕！\x1b[m"
